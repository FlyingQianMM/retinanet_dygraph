    ...
    def reader():
        if mode == "train":
            ...
            while True:
                ...
                '''               
                if id == 0:
                    if '000000127660.jpg' not in roidb['image']: continue
                else:
                    if '000000341719.jpg' not in roidb['image']: continue
                '''
                
                '''
                if id == 0:
                    #if '000000127660.jpg' not in roidb['image']: continue
                    if '000000397133.jpg' not in roidb['image']: continue
                else:
                    if '000000341719.jpg' not in roidb['image']: continue
                '''
                id += 1
