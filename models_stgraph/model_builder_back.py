...
class RetinaNet(object):
    ...
    def cls_subnet(self, subnet_input, num_conv=4, name=None):
        ...
        for i in range(num_conv):
            ...
            subnet_blob = fluid.layers.conv2d(
                ...
                padding=1,
                act='relu',
                name=name + "_sub{}_cls".format(i),
                param_attr=ParamAttr(name="sub{}_cls_w".format(i), 
                                     initializer=Normal(loc=0., scale=0.01)),
                bias_attr=ParamAttr(name="sub{}_cls_b".format(i),
                                    learning_rate=2.,
