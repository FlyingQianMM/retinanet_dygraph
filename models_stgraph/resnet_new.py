...
def layer_warp(block_func, input, ch_out, count, stride, name):
    res_out = block_func(input, ch_out, stride, name=name + "_{}".format(0))
    for i in range(1, count):
        res_out = block_func(res_out, ch_out, 1, name=name + "_{}".format(i))
    return res_out
...
def add_ResNet50_conv_body(body_input):
