...
def parse_args():
    ...
    #SOLVER
    add_arg('learning_rate',    float,  0.00125,     "Learning rate.")
    add_arg('max_iter',         int,    720000,   "Iter number.")
    add_arg('lr_steps',         int,   [480000, 640000], "lr steps_with_decay.")
    add_arg('warm_up_iter',     int,    1000,       "warm up to learning rate.")
